...
export default function List() {
    ...
    const _scrollY = scrollY.interpolate({ inputRange: [0, 1], outputRange: [0, 1], extrapolateLeft: 'clamp' });
    const headerTranslate = Animated.diffClamp(_scrollY, 0, headerHeight / 2).interpolate({
        inputRange: [0, 1],
        outputRange: [0, -1],
    });
    return (
